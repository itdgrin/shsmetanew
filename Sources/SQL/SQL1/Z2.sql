...
select 	'materialcard -> MAT_SUM_NO_NDS * (MAT_PROC_PODR / 100)'	as  O1, 
	round(sum(rezult.MAT_PROC_PODR)) 				as  C1, 	 
	
	'materialcard -> MAT_SUM_NO_NDS * ( MAT_PROC_ZAC / 100)'	as  O2,
	round(sum(rezult.MAT_PROC_ZAC)) 				as  C2, 	 
	
	'materialcard -> TRANSP_NO_NDS  * (TRANSP_PROC_PODR / 100)'	as  O3,
	round(sum(rezult.TRANSP_PROC_PODR)) 				as  C3, 	 
	
	'materialcard -> TRANSP_NO_NDS  * (TRANSP_PROC_ZAC / 100)'	as  O4,
